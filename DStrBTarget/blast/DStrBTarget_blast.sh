...
#/mnt/disk1/yueyang/work/ligand/misc/calTanimoto ../gen_files/ligIn.fpt ./seqiden50.fpt > ../gen_files/ligIn.tanimoto
...
#done &
#nohup ~/software/LSalign/LSalign -rf 1 $lig_str_file ./seqiden50_calLS/tocal995.mol2 > ../gen_files/proc10.lsalign &
#wait
...
#process and output
./DStrBTarget_process_blast.py $w1 $w2 ../gen_files/ligIn.names ./extract.tanimoto ./extract.lsalign
